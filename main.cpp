...
int main() {
    ...
    std::cout << "Problem 4: Sum of Minor Diagonal (Matrix 1): " << matrix1.sum_diagonal_minor() << std::endl;
    std::cout << "\nProblme 4: Sum of Major Diagonal (Matrix 2): " << matrix2.sum_diagonal_major() << std::endl;
    std::cout << "Problme 4: Sum of Minor Diagonal (Matrix 2): " << matrix2.sum_diagonal_minor() << std::endl;
